...
class Encoder(torch.nn.Module):
    """Encoder with Inception-style first layer, 5 stages of Conv3x3x2 + avg_pool.
    ...
    def __init__(self, resolution, e_dims):
        ...
        # d1: Inception-style 3-branch parallel
        c1 = max(1, ed // 3)
        c2 = max(1, ed // 3)
        c3 = max(1, ed - c1 - c2)
        ...
        # d2..d5 — each stage: Conv3x3 -> Conv3x3, channels scaled from ed
    ...
    def forward(self, x):
        ...
        # d1: Inception — 3 parallel branches
        b0 = self.d1_c1(x)
